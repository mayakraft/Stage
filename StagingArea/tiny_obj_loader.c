  ...
  const std::string &name)
{
  ...
  for (size_t i = 0; i < faceGroup.size(); i++) {
    ...
    for (size_t k = 2; k < npolys; k++) {
      ...
      uint16_t v0 = updateVertex(vertexCache, positions, normals, texcoords, in_positions, in_normals, in_texcoords, i0);
      uint16_t v1 = updateVertex(vertexCache, positions, normals, texcoords, in_positions, in_normals, in_texcoords, i1);
      uint16_t v2 = updateVertex(vertexCache, positions, normals, texcoords, in_positions, in_normals, in_texcoords, i2);
...
//todo pass memory location
void LogObj(std::vector<tinyobj::shape_t> shapes){
    printf("# of shapes : %lu\n", shapes.size());;
